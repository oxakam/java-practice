...
public class AggregatorApp {
	...
	public static void main(String[] args) throws IOException {
		...
		**/
		...
		AggregatorProcessor<MinAggregator> aggsProcessor = 
				new AggregatorProcessor<MinAggregator>(agg, "table.csv");
		
		double value = aggsProcessor.runAggregator(1);	//max/min aggregator in the first column
